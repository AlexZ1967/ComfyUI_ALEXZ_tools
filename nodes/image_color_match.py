    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "preset": (
                    ["mean_std", "linear", "tone_curve", "adain", "optimal_transport", "lab_cdf", "oklab_cdf", "perceptual_vgg_fast"],
                    {
                        "default": "linear",
                        "tooltip": "Метод: mean_std=стд, linear=линейная, tone_curve=кривая, adain=AdaIN норм, optimal_transport=Wasserstein, lab_cdf=Lab, oklab_cdf=Oklab, perceptual_vgg_fast=VGG.",
                    },
                ),
                "strength": (
                    "FLOAT",
