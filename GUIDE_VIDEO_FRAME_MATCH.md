...
- `resize_reference_to_video`: если референс другого размера, привести его к размеру видео.  
...
- Если референс не совпадает по размеру, включите `resize_reference_to_video` или заранее приведите референс к размеру видео.  
