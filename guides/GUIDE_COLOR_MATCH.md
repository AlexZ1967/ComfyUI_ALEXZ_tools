...
|-------|----------|----------|-------------------|
| `mean_std` | ⚡⚡⚡ | ⭐ | Нужна максимальная скорость, просто выравнить средние значения |
| `linear` | ⚡⚡ | ⭐⭐ | Баланс скорость/качество, стандартный выбор (дефолт) |
| `lab_cdf` | ⚡ | ⭐⭐⭐ | Хорошее качество, работает во всех цветовых пространствах |
| `oklab_cdf` | ⚡ | ⭐⭐⭐⭐ | Лучший результат, перцептивно улучшенный (новый) |
| `perceptual_vgg_fast` | 🐢 | ⭐⭐⭐⭐⭐ | Максимальное качество через нейросеть, медленный |
