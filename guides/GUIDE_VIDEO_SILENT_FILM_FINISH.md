...
## Назначение
Финальный стилистический слой для имитации немой пленочной проекции: ЧБ/тонировка, flicker, gate weave, мягкость и зерно.
...
- Нужно, чтобы мерцание/дрожание были связаны с ручной скоростью съемки -> обязательно подключайте `cadence_json` из `Silent Film Cadence`.
